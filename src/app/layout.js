              ...
              <ul className="navbar-nav m-auto mb-2">
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu custom-dropdown">
                    ...
                    <li><Link className="dropdown-item" href="/service/decorative-and-luxury-joinery">Decorative & Luxury Joinery</Link></li>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-3 mb-4">
                ...
                <p className="">
At [Company], we believe every wall has the potential to inspire. With a focus on quality, precision, and design, we offer professional joinery services that elevate spaces and reflect your unique style. From homes to commercial properties, we turn color into craftsmanship one project at a time.
</p>
              </div>
              ...
              <div className="col-md-3 mb-4">
                ...
                <ul className="list-unstyled">
                  <li><Link href="/service/doors-and-windows" className="text-decoration-none">Doors & Windows</Link></li>
                  <li><Link href="/service/wooden-flooring-and-panelling" className="text-decoration-none">Wooden Flooring & Panelling</Link></li>
                  <li><Link href="/service/office-and-commercial-joinery" className="text-decoration-none">Office & Commercial Joinery</Link></li>
                  <li><Link href="/service/residential-joinery-works" className="text-decoration-none">Residential Joinery Works</Link></li>
                </ul>
              </div>
            </div>
          </div>
